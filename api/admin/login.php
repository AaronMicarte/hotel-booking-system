...
try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if (password_verify($data['password'], $user['password'])) {
            // If you're using plain text passwords in development (not recommended for production)
            // Remove this condition in production
            // Comment out the password_verify above and use this instead during development
